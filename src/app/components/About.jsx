...
const About = () => {
  return (
    ...
    >
      <div className="mx-auto grid w-full max-w-6xl items-center gap-10 rounded-3xl border border-white/10 bg-white/[0.03] p-6 backdrop-blur-sm sm:p-10 lg:grid-cols-[0.85fr_1.15fr] lg:gap-14">
        ...
        <div className="rounded-2xl border border-white/10 bg-black/20 p-5 sm:p-7 lg:p-8">
