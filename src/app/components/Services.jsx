...
const Services = () => {
  return (
    <div id="services" className="w-full min-h-screen py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
      {/* Section Heading */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10 max-w-7xl mx-auto">
        ...
        <div className="bg-white/5 border border-white/12 p-6 sm:p-8 w-full h-auto min-h-[240px] sm:min-h-[260px] flex flex-col items-center justify-center rounded-xl shadow-md shadow-black/40 hover:shadow-cyan-500/10 hover:scale-105 transition duration-300 text-center cursor-pointer backdrop-blur-sm">
