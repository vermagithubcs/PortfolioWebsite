  ...
  return (
    <div id="services" className="w-full min-h-screen py-12 sm:py-16 px-4 sm:px-6 lg:px-8 z-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10 max-w-7xl mx-auto">
        ...
        <div className="bg-white/5 border border-white/70 p-6 sm:p-8 w-full h-auto min-h-[240px] sm:min-h-[260px] flex flex-col items-center justify-center rounded-xl shadow-md shadow-black/40 hover:shadow-cyan-500/10 hover:scale-105 transition duration-300 text-center cursor-pointer">
          <h2 className="text-xl sm:text-2xl font-semibold text-cyan-300">Full Stack Developer</h2>
          <p className="mt-3 sm:mt-4 text-sm sm:text-base text-slate-100 leading-relaxed">
